...
static void test_ability_display_and_skill_poster(void)
{
    ...
    assert(strcmp(capture.text,
        ...
        "PAROWANIE - SAMOCZYNNIE \n"
        "POROWNANIE-KOMEDA POROWNAJ\n"
        "POTRAWKI-SAMOCZYNNIE , PO WALCE\n"
        "POWROT-KOMEDA POWROT\n"
        "ZRECZNE RECE - KOMENDA : RECE\n"
        "KRZEPA : SAMOCZYNNIE\n"
        "TARGOWANIE SIE : SAMOCZYNNIE\n"
        "WIROWANIE - SAMOCZYNNIE \n"
        "FATALITY - SAMOCZYNNIE \n"
        "COMBO - SAMOCZYNNIE \n"
        "SUPER COMBO - SAMOCZYNNIE \n"
        "TRUCIZNA - SAMOCZYNNIE\n"
        "UZDRAWIANIE - KOMENDA UZDROW\n"
        "MOCNY SEN - SAMOCZYNNIE \n"
        "OSLEPIANIE  - KOMEDA OSLEP \n"
        "NEKROMANCJA - SAMOCZYNNIE \n"
        "SZAL - KOMEDNA SZAL\n"
        "SIATKA - KOMENDA SIATKA\n"
        "CIOS W PLECY - KOMENDA CIOS W (COS)\n"
        "ROZPALANIE OGNISKA - KOMENDA ROZPAL\n"
        "HIPER SPEED - KOMENDA SPEED\n"
        "PIECZENIE - KOMENDA PIECZ\n"
