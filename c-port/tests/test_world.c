...
int main(void)
{
    ...
    /* SWIAT.PAS rooms 0-17: the start and full MUD School route. */
    assert_route(ROOM_START, DIRECTION_NORTH, ROOM_CENTRAL);
    assert_route(ROOM_CENTRAL, DIRECTION_SOUTH, ROOM_START);
    assert_route(ROOM_CENTRAL, DIRECTION_NORTH, ROOM_CITY_THRESHOLD);
    assert_route(ROOM_CENTRAL, DIRECTION_EAST, ROOM_TRAINING);
    assert_route(ROOM_CENTRAL, DIRECTION_WEST, ROOM_SCHOOL);
    assert_route(ROOM_CENTRAL, DIRECTION_DOWN, ROOM_UNDERGROUND);
    assert_route(ROOM_SCHOOL, DIRECTION_EAST, ROOM_CENTRAL);
    ...
    assert_route(ROOM_CAGE_HALL, DIRECTION_EAST, ROOM_CAGE_WEAK);
    assert_route(ROOM_CAGE_HALL, DIRECTION_WEST, ROOM_CAGE_STRONG);
    assert_route(ROOM_CAGE_HALL, DIRECTION_NORTH, ROOM_CAGE_DEXTEROUS);
    assert_route(ROOM_CAGE_HALL, DIRECTION_SOUTH, ROOM_CAGE_RESISTANT);
    assert_route(ROOM_CAGE_HALL, DIRECTION_UP, ROOM_CAGE_ALL);
    assert_route(ROOM_CAGE_HALL, DIRECTION_DOWN, ROOM_TELEPORT);
    assert_route(ROOM_CAGE_WEAK, DIRECTION_WEST, ROOM_CAGE_HALL);
    assert_route(ROOM_CAGE_STRONG, DIRECTION_EAST, ROOM_CAGE_HALL);
    assert_route(ROOM_CAGE_DEXTEROUS, DIRECTION_SOUTH, ROOM_CAGE_HALL);
    assert_route(ROOM_CAGE_RESISTANT, DIRECTION_NORTH, ROOM_CAGE_HALL);
    assert_route(ROOM_CAGE_ALL, DIRECTION_DOWN, ROOM_CAGE_HALL);
    assert_route(ROOM_TELEPORT, DIRECTION_UP, ROOM_CAGE_HALL);
