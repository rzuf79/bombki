...
codeblob=open(r"E:\Develop\Reverse\bombki\RE\tpu_reports\MONSTRA.code.bin",'rb').read()
out=[]
...
open(r"E:\Develop\Reverse\bombki\RE\relocdump\monstra.relocs.txt",'w').write('\n'.join(out))
